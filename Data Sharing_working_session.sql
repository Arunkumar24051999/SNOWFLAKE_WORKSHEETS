...
//=======================================
// Create a Database
CREATE OR REPLACE DATABASE CUST_DB;

// Create schemas
CREATE OR REPLACE SCHEMA CUST_TBLS;
CREATE OR REPLACE  SCHEMA CUST_VIEWS;

// Create some tables in tbls schema
CREATE OR REPLACE TABLE CUST_DB.CUST_TBLS.CUSTOMER
AS SELECT * FROM SNOWFLAKE_SAMPLE_DATA.TPCH_SF1.CUSTOMER;

CREATE OR REPLACE TABLE CUST_DB.CUST_TBLS.ORDERS
