...
GRANT USAGE ON DATABASE PUBLIC_DB TO ROLE HR_ADMIN;
GRANT USAGE ON SCHEMA PUBLIC_DB.public TO ROLE HR_ADMIN;
GRANT SELECT ON TABLE PUBLIC_DB.public.CUSTOMER TO ROLE HR_ADMIN;

GRANT USAGE ON DATABASE PUBLIC_DB TO ROLE HR_USERS;
GRANT USAGE ON SCHEMA PUBLIC_DB.public TO ROLE  HR_USERS;
GRANT SELECT ON TABLE PUBLIC_DB.public.CUSTOMER TO ROLE  HR_USERS;
...
CASE WHEN CURRENT_ROLE() in ('SALES_ADMIN', 'HR_ADMIN') THEN val
